...
# 设定文件夹路径
folder_path = './data2/Data_2/Monomer_1/'
...
for idx, file_name in enumerate(file_names):
    ...
    ax.text(0.5, 1.10, f'{title} in Monomer', fontsize=15, fontweight='bold', fontname='Arial', ha='center', va='bottom',
            transform=ax.transAxes)
    ax.text(0.5, 1.04, '(Topological Torsion Fingerprints)', fontsize=12, fontweight='bold', fontname='Arial',
...
#Topological Torsion Fringerprints in xlsx
